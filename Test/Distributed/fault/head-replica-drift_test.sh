...
export FAULT_SLUG="head-replica-drift"
...
echo "[harness] running SPTAGTest --run_test=HeadReplicaDriftTest"
"$TEST_BIN" --run_test=HeadReplicaDriftTest --log_level=test_suite --report_level=short
