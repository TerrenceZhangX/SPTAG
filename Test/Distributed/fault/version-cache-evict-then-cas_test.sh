...
export FAULT_SLUG="version-cache-evict-then-cas"
...
echo "[harness] running SPTAGTest --run_test=VersionCacheEvictThenCasTest"
"$TEST_BIN" --run_test=VersionCacheEvictThenCasTest --log_level=test_suite --report_level=short
