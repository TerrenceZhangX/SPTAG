...
export FAULT_SLUG="posting-router-split-brain-append"
...
echo "[harness] running SPTAGTest --run_test=PostingRouterOwnerFailoverTest"
"$TEST_BIN" --run_test=PostingRouterOwnerFailoverTest --log_level=test_suite --report_level=short
