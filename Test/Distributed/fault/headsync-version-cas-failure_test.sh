...
export FAULT_SLUG="headsync-version-cas-failure"
...
echo "[harness] running SPTAGTest --run_test=HeadsyncVersionCasFailureTest"
"$TEST_BIN" --run_test=HeadsyncVersionCasFailureTest --log_level=test_suite --report_level=short
