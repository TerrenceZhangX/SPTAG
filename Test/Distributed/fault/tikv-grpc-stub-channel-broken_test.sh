...
export FAULT_SLUG="tikv-grpc-stub-channel-broken"
...
echo "[harness] running SPTAGTest --run_test=TikvGrpcStubChannelBrokenTest"
"$TEST_BIN" --run_test=TikvGrpcStubChannelBrokenTest --log_level=test_suite --report_level=short
