...
namespace SPTAG
{
    namespace COMMON
    {
        class TruthSet {
        public:
            static void LoadTruthTXT(std::shared_ptr<SPTAG::Helper::DiskIO>& ptr, std::vector<std::set<SizeType>>& truth, int K, int& originalK, int& p_iTruthNumber)
            {
            ...
            static void LoadTruthXVEC(std::shared_ptr<SPTAG::Helper::DiskIO>& ptr, std::vector<std::set<SizeType>>& truth, int K, int& originalK, int& p_iTruthNumber)
            {
                truth.clear();
                truth.resize(p_iTruthNumber);
            ...
            static void LoadTruthDefault(std::shared_ptr<SPTAG::Helper::DiskIO>& ptr, std::vector<std::set<SizeType>>& truth, int K, int& originalK, int& p_iTruthNumber) {
                if (ptr->TellP() == 0) {
                    int row;
            ...
            static void LoadTruth(std::shared_ptr<SPTAG::Helper::DiskIO>& ptr, std::vector<std::set<SizeType>>& truth, int& NumQuerys, int& originalK, int K, TruthFileType type)
            {
